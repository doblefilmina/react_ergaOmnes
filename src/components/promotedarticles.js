...
class PromotedArticles extends Component {
  render() { 
    return  <div className="articulos-promocionados">
              <div className="p-0 mt-3" >
                <section className="container-fluid">
                  <div className="row">
                    ...
                    {this.props.promotedarticles.map(promotedarticle => <PromotedArticle promotedarticle={promotedarticle} key={promotedarticle.id}/> )}
